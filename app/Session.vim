...
badd +1 boards/arm/nice_nano/nice_nano_v2.dts
badd +94 boards/arm/nice_nano/nice_nano.dtsi
...
badd +39 boards/arm/corneish_zen/corneish_zen_v1_left_defconfig
...
badd +40 boards/arm/corneish_zen/corneish_zen_v2_left.dts
...
badd +1 boards/arm/gamma/CMakeLists.txt
badd +1 boards/arm/planck/Kconfig.board
badd +9 boards/arm/gamma/Kconfig.board
...
badd +36 module/drivers/sensor/max17048/max17048.c
...
badd +44 boards/arm/gamma/gamma_dongle.dts
...
badd +8 dts/bindings/behaviors/zmk,behavior-check-battery.yaml
badd +73 src/behaviors/behavior_backlight.c
badd +1 include/drivers/behavior.h
...
badd +1 include/zmk/rgb_underglow.h
badd +1 dts/behaviors/to_layer.dtsi
badd +1 dts/behaviors/toggle_layer.dtsi
badd +1 dts/behaviors/transparent.dtsi
badd +1 dts/behaviors/soft_off.dtsi
badd +1 dts/behaviors/outputs.dtsi
badd +1 dts/behaviors/none.dtsi
badd +1 dts/behaviors/mouse_key_press.dtsi
badd +1 dts/behaviors/caps_word.dtsi
...
badd +16 src/workqueue.c
badd +169 ~/zephyr-sdk-0.16.3/arm-zephyr-eabi/arm-zephyr-eabi/include/sys/errno.h
badd +7 src/events/activity_state_changed.c
badd +13 include/zmk/events/activity_state_changed.h
...
badd +25 boards/arm/nrfmicro/nrfmicro_13_defconfig
badd +1 boards/shields/settings_reset/settings_reset.conf
